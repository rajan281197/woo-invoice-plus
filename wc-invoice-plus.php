 ...
 */
/**
 * Plugin Name:          WC Invoice Plus
 * Description:          WC Invoice Plus is a powerful WooCommerce plugin that seamlessly integrates into your online store to provide a hassle-free solution for generating and downloading invoices in PDF format. With just a single click, your customers can access and download professional invoices directly from the order thank you page. This user-friendly plugin enhances the post-purchase experience by offering a convenient way for customers to obtain and archive their order invoices. It also enables you, as the store owner, to generate and download order invoice PDFs directly from the backend order detail page. Simply navigate to the order details in the WooCommerce admin area and find a new metabox that allows you to generate and download the invoice PDF for any order. This feature is particularly useful when you need to provide order invoices to customers or keep a record of your sales. WC Invoice Plus simplifies the process, ensuring that you can effortlessly retrieve and store important purchase documentation with ease.
 * Version:              1.0.0
...
>>>>>>> 69003900b885e71fa46b1102e7e5cc737df07ad3:woo-invoice-plus.php
	...
	public function register_wooinvoiceplus_menu() {
		add_menu_page(
			__( 'Woo Invoice Settings', 'wc-invoice-plus' ),
			__( 'Woo Invoice Settings', 'wc-invoice-plus' ),
			'manage_options',
	...
	public function woo_invoiceplus_page() {
		// echo __( 'This is the page content', 'wc-invoice-plus' );
        ?>
...
>>>>>>> 69003900b885e71fa46b1102e7e5cc737df07ad3:woo-invoice-plus.php
        ...
        <form action="#" class="form-row" method="POST" enctype="multipart/form-data">
            ...
            <div class="text-center btn-sc"> 
                <?php submit_button(__('Save Settings', 'wc-invoice-plus'), 'primary', 'woo_invoiceplus_settings',false); ?>
                <?php submit_button( __( 'Reset Settings', 'wc-invoice-plus' ), 'secondary','woo_invoiceplus_reset_settings',false ); ?>
            </div>
        </form>
